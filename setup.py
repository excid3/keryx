...
def update_config(values = {}):
    ...
    oldvalues = {}
    try:
        fin = file('keryx_lib/keryxconfig.py', 'r')
        ...
        print ("ERROR: Can't find keryx_lib/keryxconfig.py")
        sys.exit(1)
    return oldvalues
...
class InstallAndUpdateDataDirectory(DistUtilsExtra.auto.install_auto):
    def run(self):
        values = {'__keryx_data_directory__': "'%s'" % (self.prefix + '/share/keryx/'),
