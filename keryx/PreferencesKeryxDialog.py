...
from keryx_lib.PreferencesDialog import PreferencesDialog

class PreferencesKeryxDialog(PreferencesDialog):
    __gtype_name__ = "PreferencesKeryxDialog"

    def finish_initializing(self, builder): # pylint: disable=E1002
        """Set up the preferences dialog"""
        super(PreferencesKeryxDialog, self).finish_initializing(builder)
